...
export default function AboutPageRedirect() {
    return (
        <>
            <section className="w-full h-[560px] my-[200px] bg-[url('/images/home/mobile/image-small-team.jpg')] sm:bg-[url('/images/home/tablet/image-small-team.jpg')] custom-md:bg-[url('/images/home/desktop/image-small-team.jpg')] bg-cover custom-md:bg-cover bg-no-repeat"> {/** Code by Bryan Li */}
